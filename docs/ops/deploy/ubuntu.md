...
##### Clone the Source
    ...
    mkdir -p ~/peatio
    git clone https://github.com/openware/peatio.git ~/peatio/current
    cd peatio/current
...
Read how to deal with Peatio daemons at [Peatio daemons](https://github.com/openware/peatio/blob/master/docs/peatio/daemons.md).
